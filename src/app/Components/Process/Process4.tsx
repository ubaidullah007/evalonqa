                        ...
                        <div className="Agenko-iconic-box style-two mb-40 pf_fadeup">
                            ...
                            <div className="content">
                                ...
                                <p>
                                    ...
                                    to ensure complete test coverage for every scenario.
                                </p>
                                <div className="step">Data Intelligence Phase</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-6 col-md-6 col-sm-12">
                        <div className="Agenko-iconic-box style-two mb-40 pf_fadeup">
                            ...
                            <div className="content">
                                ...
                                <div className="step">Automation Phase</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="Agenko-iconic-box style-two mb-40 pf_fadeup">
                            ...
                            <div className="content">
                                ...
                                <p>
                                    ...
                                    use AI to boost productivity and precision.
                                </p>
                                <div className="step">Workflow Optimization Phase</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="Agenko-iconic-box style-two mb-40 pf_fadeup">
                            ...
                            <div className="content">
                                ...
                                <p>
                                    ...
                                    actionable, and developer-ready.
                                </p>
                                <div className="step">Bug Intelligence Phase</div>
                            </div>
                        </div>
                    </div>
                </div>
