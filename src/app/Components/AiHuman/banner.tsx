                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-9">
                            ...
                            <div className="page-content text-md-start text-center">
                                <h1 className=" mb-30 services_title">AI is Powerful. The Human Behind It is Crucial.</h1>
                                <div className="row">
                                    <div className="col-xl-12">
                                        ...
                                        <div className=" d-flex align-items-center">
                                            ...
                                            <div className="text" style={{ fontSize: "22px" }}>
                                                <p >Artificial intelligence is transforming QA, but its effectiveness hinges entirely on the skill, critical thinking, and adaptability of the engineer wielding it. At LoopQA, we focus on cultivating exceptional human talent first.</p>
                                            </div>
                                        </div>
                                    </div>
